...
<html>
	<head>
		...
		<link href="http://fonts.googleapis.com/css?family=Roboto:400,700|Roboto+Condensed:300" rel="stylesheet">
		...
		<!--[if IE 8]>
		<link href="<?=$www_root?>bower_components/Gridlock/fs.gridlock-ie.css" rel="stylesheet">
		<script src="<?=$www_root?>js/html5shiv.js"></script>
		<![endif]-->
	...
	<body class="gridlock">
		...
		<header class="header row">
			<div class="all-full">
				<a href="<?=$www_root?>" class="logo"><span>Picticious</span>Pro</a>
			</div>
		</header>